...
public class VEA {
    ...
    static String[] p = {
        ...
        "08f169b5", "f18a8c73", "ee0b5e57",
        "368f6c79", "f4bb7a59", "5926aab4",
    ...
    static void subXor(String[] a, String b) {// a = first p array b = initial key
        ...
        String[] bArray = new String[bLength / 8];
        //split the key into 32 bit blocks and put into an array
        for (int i = 0; i < bLength; i += 8) {
